...
(describe "Read functions"
  ...
  (it "handles both CR and LF"
    (should= "foobar" (read-line-crlf (java.io.StringReader. "foobar\r\nohai\r\n"))))

  (it "handles LF before CR"
    (should= "foobar" (read-line-crlf (java.io.StringReader. "foobar\nohai\r\n"))))

  (it "only LF not OK"
    (should-throw (read-line-crlf (java.io.StringReader. "foobar\rohai\r\n"))))

  (it "needs either CR or LF"
    (should-throw (read-line-crlf (java.io.StringReader. "foobar"))))
  ...
  (it "throws exception for single \\n"
    (should-throw (read-msgs (java.io.StringReader. "foo\nbar\n") [])))
